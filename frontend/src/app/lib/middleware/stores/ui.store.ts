...
export interface ModalState { id: string; isOpen: boolean; type: ModalType; data?: any }
...
export const uiStore = {
  ...
  openModal(type: ModalType, data?: any) { const m: ModalState = { id: rid(), isOpen: true, type, data }; state = { ...state, modals: [...state.modals, m] }; notify(); return m.id; },
