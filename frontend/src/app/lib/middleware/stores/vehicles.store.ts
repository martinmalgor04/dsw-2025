import { vehicleService, VehicleDTO, VehicleFilters, CreateVehicleDTO, UpdateVehicleDTO } from '../services/vehicle.service';
...
export const vehiclesStore = {
  subscribe(fn: (s: VehiclesState) => void) {
    subs.push(fn);
    fn(state);
    return () => {
